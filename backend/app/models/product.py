...
class Product(Base):
    ...
    # 0036); every batch owns its own price outright. The column
    # itself still exists in the database, unused, per this project's
    # deprecate-first rule -- to be dropped in a later migration once
